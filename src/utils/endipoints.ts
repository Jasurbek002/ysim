...
// category tab tarifs
  ...
  // test zip
  TEST_DEVICE_UPDATE_ON:"/test/set/updated",
  TEST_DEVICE_UPDATE_OFF:"/test/set/not/updated",
  TEST_DEVICE_UPDATE_ALL_ON:"/test/set/all/notUpdated",
  TEST_DEVICE_GET_ME:"/test/get/info",
};
